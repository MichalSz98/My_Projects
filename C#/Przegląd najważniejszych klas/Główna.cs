...
namespace Projekt
{
    public partial class Main_Form : Form
    {
        ...
        //Konstruktor tej formy - Tworzy połączenie z bazą, czyta dane z pliku i uzupełnia zakładkę połączenie z bazą danych
        public Main_Form(Logowanie log)
        {
            InitializeComponent();
            this.Log = log;
        ...
        //Funkcja działająca gdy Form1 się załaduje - Ukrywanie formy Logowanie
        ...
        //Zakładka Dane
        public void Refresh_Data()                       //Odświeża dane na liście listView1
        {
        ...
        //Zakładka konta księgowych
        public void Refresh_Data2()             //Odświeża dane na liście listView2
        {
        ...
        //Wczytywanie wprost z bazy do listy Persons
        ...
        //Wczytywanie wprost z bazy do listy Ksiegowi
        ...
        //Wczytywanie wprost z bazy do listy Zwolnienia
        ...
        //Zakładka połączenie z bazą danych
        private void Polacz_Click(object sender, EventArgs e)      //Przycisk Połacz
        {
        ...
        //Zakładka połączenie z bazą danych
        private void Rozlacz_Click(object sender, EventArgs e)      //Przycisk Rozłącz
        {
            DB.CloseConnection();
            red_yellow_green.BackColor = Color.FromName("Red");
            dataGridView1.DataSource = null;
